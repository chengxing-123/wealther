  ...
  var str="";
    weather.hourly_forecast.forEach((item,index)=>{
      str=str+`
       ...
       <div class="now">
        <h2 class="now-time">${item.hour}:00</h2>
        <div class="now-img" style="background-image:url(img/${item.weather_icon_id}.png)"></div>
        <h2 class="now-wendu">${item.temperature}°</h2>
      </div>
    ...
    weather.forecast_list.forEach((item,index)=>{
      ...
      str2=str2+`
       ...
       <div class="con">
        ...
        <div class="imgH" style="background-image:url(img/${item.weather_icon_id}.png)"></div>
        <div class="heaH">${item.high_temperature}</div>
          <div class="heah">${item.low_temperature}</div>
          
          <div class="weah">${item.condition}</div>
          <div class="fengxiang">${item.wind_direction}</div>
          <div class="dengji">${item.wind_level}</div>
      </div>
